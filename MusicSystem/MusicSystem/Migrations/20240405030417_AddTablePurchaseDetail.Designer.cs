...
namespace MusicSystem.Migrations
{
    ...
    [Migration("20240405030417_AddTablePurchaseDetail")]
    partial class AddTablePurchaseDetail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicSystem.Data.Entities.PurchaseDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MusicSystem.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MusicSystem.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MusicSystem.Data.Entities.PurchaseDetail", b =>
                {
                    ...
                    b.HasOne("MusicSystem.Data.Entities.User", "User")
                        .WithMany("PurchaseDetails")
                        .HasForeignKey("UserId");
